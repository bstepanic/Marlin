...
#define STRING_CONFIG_H_AUTHOR "(BenS for Ender 3 Pro with BLTouch and SKR Mini V2)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 391.88 }
